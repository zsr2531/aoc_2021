...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("day7 part1", |b| b.iter(|| <AdventOfCode2021 as Solution<Day7>>::part1(black_box(&parsed))));
    c.bench_function("day7 part2", |b| b.iter(|| <AdventOfCode2021 as Solution<Day7>>::part2(black_box(&parsed))));
}
