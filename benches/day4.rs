...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("day4 part1", |b| b.iter(|| <AdventOfCode2021 as Solution<Day4>>::part1(black_box(parsed.clone()))));
    c.bench_function("day4 part2", |b| b.iter(|| <AdventOfCode2021 as Solution<Day4>>::part2(black_box(parsed.clone()))));
}
